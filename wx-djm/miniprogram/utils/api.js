...
var HOST_URI = config.getHostUrl;
var HOST_WECHAT = config.getHostPlus;
var QRCODEPATH = config.getQrcodePath;
var per_page = 10;
/** 定义模块 **/
module.exports = {
  // 获取文章列表数据
  ...
  //出发城市JSON
  goCityUrl() {
    var url = 'https://' + DOMAIN + '/data/gocity.php';
    return url;
  },
  //到达城市JSON
  toCityUrl() {
    var url = 'https://' + DOMAIN + '/data/tocity.php';
    return url;
  }
};